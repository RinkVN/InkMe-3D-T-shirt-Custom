  ...
  let message = {
    ...
    html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
            ...
            <div style="background-color: #ffffff; padding: 20px; border-radius: 8px;">
              <h2 style="color: #2988BC; text-align: center;">Thay đổi mật khẩu</h2>
              <p style="color: #333; font-size: 16px; text-align: center;">
                Xin chào bạn</strong>,
              </p>
              <p style="color: #333; font-size: 16px; text-align: center;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="${resetLink}" style="background-color: #2988BC; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-size: 16px; font-weight: bold;">Đổi mật khẩu</a>
              </div>
              <p style="color: #333; font-size: 14px; text-align: center;">
